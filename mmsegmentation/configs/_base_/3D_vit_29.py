...
custom3D_train = dict(
    type = 'custom3DDataset_29',
    data_root = '/home/ruitong_gan/3D/data/',
data_prefix=dict(
            img_path='3_class/crop_Image', seg_map_path='3_class/crop_GT'),
...
custom3D_val = dict(
    ...
    data_root = '/home/ruitong_gan/3D/data/',
data_prefix=dict(
            img_path='3_class/val/Image', seg_map_path='3_class/val/GT'),
...
train_cfg = dict(
    type='IterBasedTrainLoop', max_iters=160000, val_interval=1)
