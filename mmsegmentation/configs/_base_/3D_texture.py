...
data_prefix=dict(
            img_path='train/Image', seg_map_path='train/GT'),
...
custom3D_val = dict(
    ...
    data_root = '/home/ruitong_gan/3D/data/texture',
data_prefix=dict(
            img_path='val/Image', seg_map_path='val/GT'),
...
load_from = "/home/ruitong_gan/3D/mmsegmentation/work_dir/texture_chair_5000/iter_150000.pth"
